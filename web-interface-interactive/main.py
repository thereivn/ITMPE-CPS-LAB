    ...
    if st.session_state.results is not None:
        ...
        with tab1:
            ...
            **Физический смысл расширения диапазонов:**
            ...
            - При α>0 добавляется погрешность измерений, что закономерно расширяет диапазоны значений
            - Это не ошибка, а отражение реального физического процесса - чем хуже измерения, тем больше разброс данных
            """
